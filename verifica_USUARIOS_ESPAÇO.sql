...
prompt
prompt
prompt Percentual de utilização por Tablespace
prompt ===============
...
prompt
prompt
prompt Percentual disponível para crescimento por Tablespace
prompt ===============
...
prompt
prompt
prompt Percentual de Backups em Conformidade com a Política de Backup
prompt ===============
